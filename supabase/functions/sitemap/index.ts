...
const staticRoutes = [
  ...
  { path: "/crypto-factory", priority: "0.9", changefreq: "hourly" },
  ...
  { path: "/airdrops/linea", priority: "0.7", changefreq: "weekly" },
  { path: "/airdrops/monad", priority: "0.7", changefreq: "weekly" },
  { path: "/airdrops/berachain", priority: "0.7", changefreq: "weekly" },
  { path: "/airdrops/scroll", priority: "0.7", changefreq: "weekly" },
  { path: "/airdrops/hyperliquid", priority: "0.7", changefreq: "weekly" },
  { path: "/airdrops/zksync", priority: "0.7", changefreq: "weekly" },
  { path: "/airdrops/megaeth", priority: "0.7", changefreq: "weekly" },
  { path: "/airdrops/base", priority: "0.7", changefreq: "weekly" },
