    ...
    <div className="holo-card p-3 sm:p-4 md:p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4">
        ...
        <div className="flex gap-4 sm:gap-6 text-center">
          <div>
            <div className="text-success font-bold text-lg sm:text-xl">{bullish}</div>
            <div className="text-[10px] sm:text-xs text-muted-foreground flex items-center gap-1">
              <TrendingUp className="w-3 h-3" /> Bullish
            </div>
          </div>
          <div>
            <div className="text-warning font-bold text-lg sm:text-xl">{neutral}</div>
            <div className="text-[10px] sm:text-xs text-muted-foreground">Neutral</div>
          </div>
          <div>
            <div className="text-danger font-bold text-lg sm:text-xl">{bearish}</div>
            <div className="text-[10px] sm:text-xs text-muted-foreground flex items-center gap-1">
      ...
      {/* Momentum Bar */}
      <div className="h-2 sm:h-3 rounded-full overflow-hidden flex bg-muted">
        <div 
