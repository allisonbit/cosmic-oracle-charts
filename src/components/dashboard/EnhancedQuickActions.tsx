        ...
        <DialogContent className="max-w-md bg-background/95 backdrop-blur-xl border-primary/20">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-3">
              {selectedAction && (
                <>
                  <div className={cn("w-10 h-10 rounded-full flex items-center justify-center bg-primary/20")}>
                    <selectedAction.icon className={cn("w-5 h-5", selectedAction.color)} />
                  </div>
                  <div>
                    <span className="font-display text-lg">{selectedAction.label}</span>
                    <p className="text-sm text-muted-foreground font-normal">{selectedAction.description}</p>
                  </div>
                </>
              )}
            </DialogTitle>
            ...
            <div className="space-y-4 mt-4">
              <div className="holo-card p-4">
                ...
                <ul className="space-y-2">
                  {selectedAction.features.map((feature, i) => (
