...
export function PredictionHero({ coinName, coinId, symbol, timeframe, data }: PredictionHeroProps) {
  ...
  const accent =
    data.bias === 'bullish' ? 'border-success' :
    data.bias === 'bearish' ? 'border-danger' :
    'border-warning';

  return (
    <div className="space-y-5">
      {/* Hero — colored left accent instead of a card box */}
      <div className={cn("border-l-4 pl-5", accent)}>
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-5">
          ...
          <div className="text-left sm:text-right">
            <div className="section-label mb-0.5">Current Price</div>
        ...
        {/* Probability bars — labeled, no box */}
        <div className="grid grid-cols-2 gap-6 border-t border-border/20 pt-4">
          <div>
      ...
      <div className="border-t border-border/30 pt-4">
        ...
        <div className="flex flex-wrap items-center gap-3 mt-3 pt-3 border-t border-border/20 text-xs text-muted-foreground">
