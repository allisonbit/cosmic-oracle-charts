...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden cosmic-bg">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-56 md:w-80 h-56 md:h-80 bg-secondary/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1s" }} />
      ...
      <div className="container mx-auto px-4 py-16 md:py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="relative flex justify-center items-center mt-8 lg:mt-0">
            {/* Glow ring */}
            <div className="absolute w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full border-2 border-primary/30 animate-pulse pulse-glow" />
            <div className="absolute w-56 h-56 md:w-72 md:h-72 lg:w-80 lg:h-80 rounded-full border border-secondary/20" style={{ animationDelay: "0.5s" }} />
            
            {/* Oracle container */}
            <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-[450px] lg:h-[450px] rounded-full overflow-hidden float">
              <img
                src={cosmicOracle}
                alt="Oracle - AI Crypto Guide"
            ...
            {/* Floating data cards */}
            <div className="absolute top-4 md:top-10 -left-2 md:left-0 holo-card p-2 md:p-3 float animate-fade-in" style={{ animationDelay: "0.3s" }}>
            ...
            <div className="absolute bottom-16 md:bottom-20 -right-2 md:right-0 holo-card p-2 md:p-3 float-delayed animate-fade-in" style={{ animationDelay: "0.6s" }}>
