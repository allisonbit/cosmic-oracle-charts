...
export function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-background/80 border-b border-border shadow-elevation-md safe-area-top">
            ...
            <div className="hidden lg:flex items-center gap-0.5">
              {PRIMARY_NAV.map((item) => (
                <Link
                  ...
                  to={item.path}
                  className={cn(
                    "px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 ease-out whitespace-nowrap",
