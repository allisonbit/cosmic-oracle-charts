            ...
            <DialogTitle className="flex items-center gap-3">
              {selectedMetric && (
                <>
                  <div className={cn(
                    "p-2 rounded-lg",
                    selectedMetric.color === "primary" && "bg-primary/20",
                    selectedMetric.color === "success" && "bg-success/20",
                    selectedMetric.color === "warning" && "bg-warning/20",
                    selectedMetric.color === "secondary" && "bg-secondary/20"
                  )}>
                    <selectedMetric.icon className={cn(
                      "h-5 w-5",
                      selectedMetric.color === "primary" && "text-primary",
                      selectedMetric.color === "success" && "text-success",
                      selectedMetric.color === "warning" && "text-warning",
                      selectedMetric.color === "secondary" && "text-secondary"
                    )} />
                  </div>
                  <div>
                    <span className="text-lg font-display">{selectedMetric.label}</span>
                    <p className="text-sm text-muted-foreground font-normal">{selectedMetric.description}</p>
                  </div>
                </>
              )}
            </DialogTitle>
          ...
          {selectedMetric && (
            <div className="space-y-4 py-4">
              ...
              <div className="p-4 rounded-xl bg-muted/20 border border-border/30 text-center">
                ...
                <p className="text-3xl font-display text-foreground">{selectedMetric.value}</p>
              </div>
              ...
              <a 
                ...
                className="flex items-center justify-center gap-2 p-3 rounded-lg bg-primary/20 text-primary hover:bg-primary/30 transition-colors text-sm"
              >
